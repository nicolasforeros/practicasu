...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-header font-weight-bold">{{ __('New Internship Offer') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('company.internship_offer.store',$company) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contact_phone" type="tel" class="form-control @error('contact_phone') is-invalid @enderror" name="contact_phone" value="{{ old('contact_phone') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="vacancies" type="number" class="form-control @error('vacancies') is-invalid @enderror" name="vacancies" value="{{ old('vacancies') }}" required min="0">
